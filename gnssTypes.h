#include <inttypes.h>
#include <Arduino.h>
#include "gnssDefines.h"

#define GPSP_SIZE 18

#ifndef __GNSSLIBRARY_H__
#define __GNSSLIBRARY_H__
...
private:
    ...
    NMEAType_t GetNmeaType(char *tht_buf);
    ...
    void DecodeRMC(rmc_t *Dst, char **Buf);
    void DecodeVTG(vtg_t *Dst, char **Buf);
    void DecodeGGA(gga_t *Dst, char **Buf);
    void DecodeGSA(gsa_t *Dst, char **Buf);

    void DecodeGLL(gll_t *Dst, char **Buf);
    void DecodeTXT(txt_t *Dst, char **Buf);
...
public:
    ...
    void RmcCpy(rmc_t *Dst, rmc_t Src);
    void VtgCpy(vtg_t *Dst, vtg_t Src);
    void GgaCpy(gga_t *Dst, gga_t Src);
    void GsaCpy(gsa_t *Dst, gsa_t Src);

    void printRMC(rmc_t Src);
    void printVTG(vtg_t Src);
    void printGGA(gga_t Src);
    void printGSA(gsa_t Src);

    void getRMC(rmc_t *Dst);
    void getVTG(vtg_t *Dst);
    void getGGA(gga_t *Dst);
    void getGSA(gsa_t *Dst);
};
